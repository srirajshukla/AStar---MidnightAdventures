...
public class Grid : MonoBehaviour
{
    ...
    /// <summary>
    /// This method returns the neighbours of any node in the grid. 
    /// </summary>
    /// <param name="node">
    ///     The node whose neighbours are to be found. 
    /// </param>
    /// <returns>
    /// Returns a list of nodes that are neighbours of the given node.  
    /// </returns>
